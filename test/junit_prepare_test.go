...
import (
	...
	"github.com/hamster-shared/hamster-gateway/cmd"
...
func TestInit(t *testing.T) {
	ctx := cmd.NewContext("tomato denial broccoli video correct spring link oval ostrich category stereo beauty", "ws://127.0.0.1:9944")
